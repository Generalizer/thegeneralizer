...
inference_help <- function(){
  ...
  if(pop == 1){
    cat("We have an in-built dataset 'k12', which is taken from Common Core Data 2016-2017. This is population data on all public elementary and secondary schools in the US. ")
  }
  if(pop == 2){
